    ...
    <div className="flex flex-row justify-center items-center gap-5 sm:gap-16 font-montserrat text-slate-gray">
      <section className="flex justify-center items-center gap-1">
        ...
        <p className="font-bold">
          {dataHumidity === undefined ? "59" : dataHumidity}
      ...
      <section className="flex justify-center items-center gap-1">
        ...
        <p className="font-bold">
          {dataClouds === undefined ? "40" : dataClouds}
          <span className="text-[12px]">mm</span>
        </p>
      </section>
      ...
      <section className="flex justify-center items-center gap-1">
        ...
        <p className="font-bold">
          {dataWind === undefined ? "1.54" : dataWind}
          <span className="text-[12px]">km</span>
        </p>
      ...
      <section className="flex justify-center items-center gap-1">
        ...
        <section className="flex ">
          <p className="font-bold">
            {dataTempFeeelsLike === undefined
              ? "40"
              : Math.round(dataTempFeeelsLike)}
          </p>
        </section>
